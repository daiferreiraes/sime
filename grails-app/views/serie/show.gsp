	...
	<body>
		...
		<div id="show-serie" class="content scaffold-show" role="main">
			...
			<ol class="property-list serie">
				...
				<g:if test="${serieInstance?.descricao}">
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="serie.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${serieInstance}" field="descricao"/></span>
