		...
		<div id="list-serie" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'serie.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${serieInstanceList}" status="i" var="serieInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${serieInstance.id}">${fieldValue(bean: serieInstance, field: "descricao")}</g:link></td>
