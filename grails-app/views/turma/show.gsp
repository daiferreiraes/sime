	...
	<body>
		...
		<div id="show-turma" class="content scaffold-show" role="main">
			...
			<ol class="property-list turma">
				...
				<g:if test="${turmaInstance?.numvagas}">
				<li class="fieldcontain">
					<span id="numvagas-label" class="property-label"><g:message code="turma.numvagas.label" default="Numvagas" /></span>
					
						<span class="property-value" aria-labelledby="numvagas-label"><g:fieldValue bean="${turmaInstance}" field="numvagas"/></span>
