	...
	<body>
		...
		<div id="show-turno" class="content scaffold-show" role="main">
			...
			<ol class="property-list turno">
				...
				<g:if test="${turnoInstance?.descricao}">
				<li class="fieldcontain">
					<span id="descricao-label" class="property-label"><g:message code="turno.descricao.label" default="Descricao" /></span>
					
						<span class="property-value" aria-labelledby="descricao-label"><g:fieldValue bean="${turnoInstance}" field="descricao"/></span>
