		...
		<div id="list-turno" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="descricao" title="${message(code: 'turno.descricao.label', default: 'Descricao')}" />
				...
				<g:each in="${turnoInstanceList}" status="i" var="turnoInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${turnoInstance.id}">${fieldValue(bean: turnoInstance, field: "descricao")}</g:link></td>
